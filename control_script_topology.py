...
shuffles = [True] # True to make all agents randomly sequenced to avoid preferential attachment/small world issues
ts_spl = ''
...
social_diffusion.run(trial_description,
        ...
        af0s,group_tfs,afts,labels,merges=merges,shuffles=shuffles,ts_spl=ts_spl)